...
#include "CrashReporter/CrashReportPy.cpp"
...
{
    return Py::String(getParsedCrashReportPtr()->pathToRawReportFile);
}
...
Py::Object CrashReportPy::getfault_address() const
{
    ...
    return static_cast<Py::Object>(Py::Long(faultAddress.value()));
}
...
{
    return Py::String(getParsedCrashReportPtr()->faultName);
}

Py::Boolean CrashReportPy::getpartial_write() const
{
    return Py::Boolean(getParsedCrashReportPtr()->partialWrite);
}

Py::Boolean CrashReportPy::getcapture_was_signal_safe() const
{
    return Py::Boolean(getParsedCrashReportPtr()->captureWasSignalSafe);
}
...
Py::Object CrashReportPy::getbuild_id() const
{
    ...
    return static_cast<Py::Object>(Py::String(buildID.value()));
}
...
Py::Object CrashReportPy::getminidump_path() const
{
    ...
    return static_cast<Py::Object>(Py::String(minidumpPath.value()));
}
...
Py::Object CrashReportPy::getos_version() const
{
    ...
    return static_cast<Py::Object>(Py::String(osVersion.value()));
}
...
{
    return Py::Boolean(getParsedCrashReportPtr()->symbolicated);
}
