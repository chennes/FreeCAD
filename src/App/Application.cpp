...
{
    return _appDirs->getTempPath().string();
}

std::string Application::getTempFileName(const char* FileName)
{
    return _appDirs->getTempFileName(FileName).string();
}

std::string Application::getUserCachePath()
{
    return _appDirs->getUserCachePath().string();
}

std::string Application::getUserConfigPath()
{
    return _appDirs->getUserConfigPath().string();
}

std::string Application::getUserAppDataDir()
{
    return _appDirs->getUserAppDataDir().string();
}

std::string Application::getUserMacroDir()
{
    return _appDirs->getUserMacroDir().string();
}

std::string Application::getResourceDir()
{
    return _appDirs->getResourceDir().string();
}

std::string Application::getLibraryDir()
{
    return _appDirs->getLibraryDir().string();
}

std::string Application::getHelpDir()
{
    return _appDirs->getHelpDir().string();
}
